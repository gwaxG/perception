...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt', img_size=416, half=False):
        ...
        rospy.Subscriber('/camera/rgb/image_raw', Image, self.update; queue_size=1)
    ...
    def update(self, rgb):
        ...
        self.imgs[self.index] = cv_rgb_image

    def update_(self, index, cap):
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=416, batch_size=16, augment=False, hyp=None, rect=True, image_weights=False,
        ...
        print('PATH TO OPEN {}'.format(path_))
